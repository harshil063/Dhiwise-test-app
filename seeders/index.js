...
async function seedUser () {
  try {
    ...
    userToBeInserted = {
      'password':'pTxZ6eJBGLxq6XW',
      'isDeleted':false,
      'username':'Fanny_Jerde',
      'email':'Hazle.Casper38@hotmail.com',
      'isActive':true,
      'userType':authConstant.USER_TYPES.User
    };
    userToBeInserted.password = await bcrypt.hash(userToBeInserted.password, 8);
    let user = await userDb.updateOne( { 'username':'Fanny_Jerde' }, userToBeInserted,  {
      upsert: true,
      new: true
    });
    userToBeInserted = {
      'password':'WJe5tQS7boWqpcS',
      'isDeleted':false,
      'username':'Katelynn_Torphy53',
      'email':'Nedra.Batz@gmail.com',
      'isActive':true,
      'userType':authConstant.USER_TYPES.Admin
    };
    userToBeInserted.password = await bcrypt.hash(userToBeInserted.password, 8);
    let admin = await userDb.updateOne( { 'username':'Katelynn_Torphy53' }, userToBeInserted,  {
      upsert: true,
      new: true
    });
