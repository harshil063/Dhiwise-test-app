...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Albertha78',
      password: 'ERl5darJaiDL1Az',
      email: 'Elaina.Rogahn35@hotmail.com',
      name: 'Miss Glenn Emmerich',
      userType: 95,
      mobileNo: '(319) 338-7541',
      resetPasswordLink: {},
      loginRetryLimit: 127,
      loginReactiveTime: '2023-09-20T16:25:52.858Z',
      id: '64c9e51b2fc6ad44c1655c96'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Deron_Grimes',
        'password':'pncWkuc35mluWi9',
        'email':'Ford25@hotmail.com',
        'name':'Miss Erin Ziemann',
        'userType':authConstant.USER_TYPES.User,
        'mobileNo':'(601) 689-9936',
